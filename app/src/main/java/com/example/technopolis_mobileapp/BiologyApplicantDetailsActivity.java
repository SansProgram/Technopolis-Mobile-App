...
public class BiologyApplicantDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biology_applicant_details);
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM biologyTA WHERE name = ?", new String[]{name});
        ...
        approveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DBHelper dBhelper = new DBHelper(BiologyApplicantDetailsActivity.this);
                ...
                if (cursor.moveToFirst()) {
                    int emailColumnIndex = cursor.getColumnIndex("email");
                    String email = cursor.getString(emailColumnIndex);
                    String subject = "Your Biology TA application has been Approved ";
                    ...
                    db.delete("biologyTA", "name=?", new String[]{name});
                    db.close();

                    Toast.makeText(BiologyApplicantDetailsActivity.this, "Approved", Toast.LENGTH_SHORT).show();
                    finish();
                }
                cursor.close();
            }
        ...
        disapproveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.moveToFirst()) {
                    int emailColumnIndex = cursor.getColumnIndex("email");
                    String email = cursor.getString(emailColumnIndex);
                    String subject = "Your Biology TA application has been Rejected ";
                    ...
                    Toast.makeText(BiologyApplicantDetailsActivity.this, "Rejected", Toast.LENGTH_SHORT).show();
                    finish();
                }
                cursor.close();
            }
