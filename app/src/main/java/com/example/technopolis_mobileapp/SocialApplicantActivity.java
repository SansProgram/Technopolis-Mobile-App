...
public class SocialApplicantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_social_applicant);
        setTitle("Applicants for Social");
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM socialTA", null);

        if (cursor.moveToFirst()) {
            int nameColumnIndex = cursor.getColumnIndex("name");
            do {
                String name = cursor.getString(nameColumnIndex);
                applicantsList.add(new SocialApplicantActivity.Applicant(name));
        ...
        usernamesListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(SocialApplicantActivity.this, SocialApplicantDetailsActivity.class);
