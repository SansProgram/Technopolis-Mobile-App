...
public class EconomicsApplicantDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_economics_applicant_details);
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM economicsTA WHERE name = ?", new String[]{name});
        ...
        approveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DBHelper dBhelper = new DBHelper(EconomicsApplicantDetailsActivity.this);
                ...
                if (cursor.moveToFirst()) {
                    int emailColumnIndex = cursor.getColumnIndex("email");
                    String email = cursor.getString(emailColumnIndex);
                    String subject = "Your Economics TA application has been Approved ";
                    ...
                    db.delete("economicsTA", "name=?", new String[]{name});
                    db.close();

                    Toast.makeText(EconomicsApplicantDetailsActivity.this, "Approved", Toast.LENGTH_SHORT).show();
                    finish();
                }
                cursor.close();
            }
        ...
        disapproveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.moveToFirst()) {
                    int emailColumnIndex = cursor.getColumnIndex("email");
                    String email = cursor.getString(emailColumnIndex);
                    String subject = "Your Economics TA application has been Rejected ";
                    ...
                    Toast.makeText(EconomicsApplicantDetailsActivity.this, "Rejected", Toast.LENGTH_SHORT).show();
                    finish();
                }
                cursor.close();
            }
