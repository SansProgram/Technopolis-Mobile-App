...
public class ScienceApplicantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_applicant);
        setTitle("Applicants for Science");
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM scienceTA", null);

        if (cursor.moveToFirst()) {
            int nameColumnIndex = cursor.getColumnIndex("name");
            do {
                String name = cursor.getString(nameColumnIndex);
                applicantsList.add(new Applicant(name));
        ...
        usernamesListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(ScienceApplicantActivity.this, ScienceApplicantDetailsActivity.class);
