...
public class PhysicsApplicantDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physics_applicant_details);setTitle("Applicant Details");
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM physicsTA WHERE name = ?", new String[]{name});
        ...
        approveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DBHelper dBhelper = new DBHelper(PhysicsApplicantDetailsActivity.this);
                ...
                if (cursor.moveToFirst()) {
                    int emailColumnIndex = cursor.getColumnIndex("email");
                    String email = cursor.getString(emailColumnIndex);
                    String subject = "Your Physics TA application has been Approved ";
                    ...
                    db.delete("physicsTA", "name=?", new String[]{name});
                    db.close();

                    Toast.makeText(PhysicsApplicantDetailsActivity.this, "Approved", Toast.LENGTH_SHORT).show();
                    finish();
                }
                cursor.close();
            }
        ...
        disapproveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.moveToFirst()) {
                    int emailColumnIndex = cursor.getColumnIndex("email");
                    String email = cursor.getString(emailColumnIndex);
                    String subject = "Your Physics TA application has been Rejected ";
                    ...
                    Toast.makeText(PhysicsApplicantDetailsActivity.this, "Rejected", Toast.LENGTH_SHORT).show();
                    finish();
                }
                cursor.close();
            }
