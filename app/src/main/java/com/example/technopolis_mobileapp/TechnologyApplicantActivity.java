...
public class TechnologyApplicantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_technology_applicant);
        setTitle("Applicants for Technology");
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM technologyTA", null);

        if (cursor.moveToFirst()) {
            int nameColumnIndex = cursor.getColumnIndex("name");
            do {
                String name = cursor.getString(nameColumnIndex);
                applicantsList.add(new TechnologyApplicantActivity.Applicant(name));
        ...
        usernamesListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(TechnologyApplicantActivity.this, TechnologyApplicantDetailsActivity.class);
