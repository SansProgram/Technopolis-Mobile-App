...
public class TechnologyApplicantDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_technology_applicant_details);
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM technologyTA WHERE name = ?", new String[]{name});
        ...
        approveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DBHelper dBhelper = new DBHelper(TechnologyApplicantDetailsActivity.this);
                ...
                if (cursor.moveToFirst()) {
                    ...
                    db.delete("technologyTA", "name=?", new String[]{name});
                    db.close();

                    Toast.makeText(TechnologyApplicantDetailsActivity.this, "Approved", Toast.LENGTH_SHORT).show();
                    finish();
                }
                cursor.close();
            }
        ...
        disapproveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.moveToFirst()) {
                    int emailColumnIndex = cursor.getColumnIndex("email");
                    String email = cursor.getString(emailColumnIndex);
                    String subject = "Your Technology TA application has been ";
                    ...
                    Toast.makeText(TechnologyApplicantDetailsActivity.this, "Rejected", Toast.LENGTH_SHORT).show();
                    finish();
                }
                cursor.close();
            }
