...
public class PhysicsApplicantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physics_applicant);
        setTitle("Applicants for Physics");
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM physicsTA", null);

        if (cursor.moveToFirst()) {
            int nameColumnIndex = cursor.getColumnIndex("name");
            do {
                String name = cursor.getString(nameColumnIndex);
                applicantsList.add(new PhysicsApplicantActivity.Applicant(name));
        ...
        usernamesListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(PhysicsApplicantActivity.this, PhysicsApplicantDetailsActivity.class);
