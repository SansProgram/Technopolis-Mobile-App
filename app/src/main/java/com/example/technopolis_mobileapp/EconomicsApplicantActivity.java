...
public class EconomicsApplicantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_economics_applicant);
        setTitle("Applicants for Economics");
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM economicsTA", null);

        if (cursor.moveToFirst()) {
            int nameColumnIndex = cursor.getColumnIndex("name");
            do {
                String name = cursor.getString(nameColumnIndex);
                applicantsList.add(new EconomicsApplicantActivity.Applicant(name));
        ...
        usernamesListView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(EconomicsApplicantActivity.this, EconomicsApplicantDetailsActivity.class);
