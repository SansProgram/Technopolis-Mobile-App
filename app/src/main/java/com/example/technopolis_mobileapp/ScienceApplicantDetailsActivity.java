...
public class ScienceApplicantDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_applicant_details);
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM scienceTA WHERE name = ?", new String[]{name});
...
//                DBHelper dBhelper = new DBHelper(ScienceApplicantDetailsActivity.this);
//                SQLiteDatabase db = dBhelper.getWritableDatabase();
//                db.delete("scienceTA", "name=?", new String[]{name});
//                db.close();
//
//                Toast.makeText(ScienceApplicantDetailsActivity.this, "Approved", Toast.LENGTH_SHORT).show();
//                finish();
//            }
//        });
        ...
        approveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.moveToFirst()) {
                    int emailColumnIndex = cursor.getColumnIndex("email");
                    String email = cursor.getString(emailColumnIndex);
                    String subject = "Your Science TA application has been ";
...
//                db.close();
//
//                Toast.makeText(ScienceApplicantDetailsActivity.this, "Disapproved", Toast.LENGTH_SHORT).show();
//                finish();
//            }
//        });
        ...
        disapproveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    Toast.makeText(ScienceApplicantDetailsActivity.this, "Rejected", Toast.LENGTH_SHORT).show();
                    finish();
                }
                cursor.close();
            }
